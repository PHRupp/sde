...
class DiffusionMapsPat():
    ...
    modified to improve time complexity and space complexity by reducing
    diagonal matrices to 1D arrays and utilizing numpy array multiplication
    capabilities.
    """
    ...
    @staticmethod
    def find_diffusion_map(P_prime, D_left, n_eign):
